...
-- Create a table for training sessions.
...
create policy "All sessions are readable by anyone." on sessions for
select using (true);

create policy "New sessions are writable by anyone." on sessions for
insert with check (true);

create policy "Anyone can update existing sessions." on sessions for
update using (true);